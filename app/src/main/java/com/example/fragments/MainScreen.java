...
import com.example.fragments.databinding.FragmentMainScreenBinding;
...
public class MainScreen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMainScreenBinding.inflate(getLayoutInflater(), container, false);

        binding.searchBtn.setOnClickListener(v -> {
            String url = binding.textInput.getText().toString();
